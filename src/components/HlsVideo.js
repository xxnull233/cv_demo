...
export function HlsVideo({
  ...
  return (
    ...
    >
      ...
      />
      {buffering && (
        <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", zIndex: 5, color: "#f8fafc", fontSize: 16, fontWeight: "700", background: "rgba(0,0,0,0.55)", padding: "8px 18px", borderRadius: 8, pointerEvents: "none" }}>
          {"正在缓冲..."}
        </div>
      )}
      <div
      ...
      />
      {seeking && (
        <div style={{ position: "absolute", top: "40%", left: "50%", transform: "translate(-50%, -50%)", background: "rgba(0,0,0,0.65)", color: "#f8fafc", padding: "6px 18px", borderRadius: 8, fontSize: 20, fontWeight: "700", pointerEvents: "none", zIndex: 20, whiteSpace: "nowrap" }}>
